  ...
  return {
    ...
    controller: ["$scope", function ($scope) {
      ...
      function _position_autocomplete() {
        ...
        // console.log("RectTop %s", rect.top);
        // console.log("RectLeft %s", rect.left);
        // console.log("ScrollTop %s", scrollTop);
        // console.log("ScrollLeft %s", scrollLeft);
        
        //container.style.top = rect.top + rect.height + scrollTop + 'px'; //EDIT
        //container.style.left = rect.left + scrollLeft + 'px'; //EDIT
      ...
      function _attach(ngmodel, target_element, options) {
        ...
        value_watch = $scope.$watch(
          ...
          function (nv, ov) {
            ...
            if (nv === last_selected_value  && nv !== undefined) //EDIT
              return;
